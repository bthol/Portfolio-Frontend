                ...
                <main className="app-main">
                    <section className="main-section-style shadow-behind">
                        ...
                        <div className="main-section-style-content">
                            ...
                            <p>Problems like the inconsistent spacing at the bottom and the need for the useless block will be ressolved by a flexible grid layout in the generic page template that is still in development at the moment.</p>
                        </div>
                        <br />
                    </section>
                </main>
